Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/allenscmo/telematics-specs"
  s.license          = 'MIT'
  s.author           = { "Stephen Celis" => "stephen@stephencelis.com" }
  s.source           = { :git => "https://github.com/allenscmo/telematics-specs.git", :tag => s.version.to_s }
